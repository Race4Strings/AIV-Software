      ...
      <form onSubmit={handleSubmit} className="grid gap-6">
        <div className="grid gap-2">
          <input
            ...
            onPaste={handlePaste}
            className="w-full px-3.5 py-3 rounded-xl bg-white/[0.06] border border-white/[0.12] text-white text-lg placeholder:text-white/20 focus-visible:ring-1 focus-visible:ring-ring focus-visible:outline-none focus:outline-none focus:border-blue-500 transition-colors duration-150 font-mono tracking-[0.3em] text-center"
            maxLength={6}
