          ...
          {guardrails ? (
            ...
            <Card>
              <CardContent className="py-8 text-center text-muted-foreground">
                ...
                <p>No guardrails configured yet. Use the Training Area to set up behavioral rules.</p>
              </CardContent>
            </Card>
          )}
        </TabsContent>
          ...
          {licensingRules ? (
                ...
                <Card>
                  <CardContent className="pt-6">
                    ...
                    <div className="text-2xl font-bold mt-1">
                      ${(licensingRules as Record<string, number>).pricing_floor?.toLocaleString() || "—"}
                    </div>
                  </CardContent>
                </Card>
                <Card>
                  <CardContent className="pt-6">
                    ...
                    <div className="text-lg font-medium mt-1">
                      {(licensingRules as Record<string, boolean>).exclusivity_available ? "Available" : "Not available"}
                    </div>
                  </CardContent>
                </Card>
                <Card>
                  <CardContent className="pt-6">
                    ...
                    <div className="text-lg font-medium mt-1">
                      {(licensingRules as Record<string, number>).default_grace_period_hours || 48}h
                    </div>
                  </CardContent>
                </Card>
              </div>
            ...
            <Card>
              <CardContent className="py-8 text-center text-muted-foreground">
                ...
                <p>No licensing rules configured yet. Set pricing, territories, and deal parameters.</p>
              </CardContent>
            </Card>
          )}
        </TabsContent>
